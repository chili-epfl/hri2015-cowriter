...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
% * <deanna.m.hood@gmail.com> 2014-09-05T11:44:33.364Z:
%
% capitalise inside the phrase?
%


%%% HRI 2015 -> double-blind review process

% * <deanna.m.hood@gmail.com> 2014-09-05T11:44:54.921Z:
%
% Ana Paiva is a reviewer....
%
...
% * <deanna.m.hood@gmail.com> 2014-09-08T11:08:36.426Z:
%
% linking sentence...
%
...
affordable humanoid robots.  Section \ref{sec:experiment} explores the novel% * <deanna.m.hood@gmail.com> 2014-09-08T11:09:28.480Z:
%
...
In \cite{Chandra2013}, it was found that children aged 4-6 years participating% * <deanna.m.hood@gmail.com> 2014-09-05T11:43:42.851Z:
%
...
\begin{figure}[thpb]
     \begin{center}
        ...
        %}%
        \subfigure{
            \includegraphics[width=0.9\linewidth]{figures/naoWriting2.png}
        }%
%
    \end{center}
...
\begin{figure}[htpb]
    ...
    marker to represent the origin of the writing surface frame. The robot's
    camera image is on the left (the text trajectory overlay is also visible).}
...
demonstration. }.
% * <deanna.m.hood@gmail.com> 2014-09-04T11:40:30.176Z:
%
...
\begin{tikzpicture}[
    ...
    \node [cmpt, fill=Turquoise!50, below=of tactile] (shape) {shape position \\ manager};
    \node [cmpt, fill=Turquoise!50, left=of shape] (learner) {letter \\ learner};
    \node [cmpt, fill=Turquoise!50, left=of learner] (card) {card \\ detector};
...
\caption{Overview of the system. The top row runs on the tablet, the middle row on the central controller and the bottom row on the robot.}
...
\subsection{Outcomes of Preliminary Studies}% * <deanna.m.hood@gmail.com> 2014-09-05T08:43:38.105Z:
%
% I guess this is what we call the non-experiments.. Are the dates important?
%
% ^ <deanna.m.hood@gmail.com> 2014-09-09T09:11:57.672Z.
...
deviation of 2.3). % * <deanna.m.hood@gmail.com> 2014-09-05T09:25:41.865Z:
%
% We prompted them when time was short, didn't we? Or did they just say test
...
\begin{itemize}% * <deanna.m.hood@gmail.com> 2014-09-05T09:34:46.545Z:
%
% taking this out of bullet points gains extra space in paper if needed
%
    ...
    \item \textbf{The children were engaged in teaching the robot.} % * <deanna.m.hood@gmail.com> 2014-09-05T09:54:48.069Z:
    %
    ...
    \item \textbf{The system has been validated as a technically sound
        ...
        in the day.% * <deanna.m.hood@gmail.com> 2014-09-05T10:49:26.786Z:
    %
    % could probably get away without mentioning this....
    %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Towards Long-term Interventions}

As noted in the introduction, existing literature on handwriting interventions
agrees to consider 20 hours spread over 20 weeks as a reasonable intervention
duration to measure actual effects. This directly questions how suitable is our
approach for such long-term interactions, and raises several challenges, both
technical and human.
...
require to be extended in non-trivial ways to allow for long, fully autonomous,
interactions with children. Also, further research may discover how to best
model/limit the learning speed of the robot so that it is noticeably learning
while not improving so fast as to limit the long-term interaction potential for
the system, which may turn out to be child-dependent.
...
the learner: the child must engage in a (meta-)cognitive relation with the robot
...
and embodiment induce agency and anthropomorphizing, and cognitively engage the
child into the learning activity, which we predict to lead to higher learning
efficacy.
