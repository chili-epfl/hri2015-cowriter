...
\begin{figure}[thpb]
     \begin{center}
        ...
        %}%
        \subfigure{
            \includegraphics[width=0.8\linewidth]{figures/naoWriting2.png}
        }%
%
    \end{center}
...
\end{figure}
\footnotetext{See
\url{https://www.youtube.com/watch?v=2qWFSJRxCU0} for a video of the synchronised writing 
demonstration. }
...
was between 8 and 15 minutes, with an average of 11.4 minutes (SD = 2.3). % * <deanna.m.hood@gmail.com> 2014-09-05T09:25:41.865Z:
%
...
As noted in the introduction, a conclusion drawn in~\cite{Hoy2011} is that any 
...
research questions which involve the measurement of learning gains to gauge effects. 
Several challenges are raised in developing such long-term capabilities for the system,
 from both technical and socialogical points of view. %not sure this makes sense
...
suggest that constructing such a social interaction is not a trivial task. Anectodes 
...
How the child's perception of the robot as a learning agent may change over the 
long-term remains to be seen. On one occasion during the preliminary studies, a 
child's response to whether the {\sc nao} could write its own name included that it 
...
extend the interaction for the long-term, as the present system with a learning rate 
...
addition of such a teachable robotic agent would have, including with respect to the 
participants' self-esteem, motivation, or learning gains. % does it impact the
