...
Using a database of children's letters when
...
inappropriately. Nevertheless, our current shape model
generated from PCA on a dataset of only adults' writing has shown to be
initial well-suited to generate `poor' letters which are appropriate for 
simulating a na\"ive learner.
